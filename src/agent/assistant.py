...
def get_assistant(session_id: str, extra_tools: list = None, channel: str = "whatsapp", extra_instructions: list = None, include_scheduler: bool = True, include_knowledge: bool = True, user_id: str = None) -> Agent:
    ...
    base_instructions = [
        ...
        "\n  4. DESTINO DE ENTREGA (OBRIGATORIO antes de gerar):"
        "\n     - Se o usuario JA mencionou onde quer receber ('manda no zap', 'envia na web'), va direto."
        "\n     - Se o usuario NAO mencionou canal, PERGUNTE: 'Quer receber aqui no [canal atual] ou na [outro canal]?'"
        "\n     - Aguarde a resposta antes de gerar."
        "\n  5. Chame generate_image. NUNCA preencha delivery_channel por conta propria."
        "\n     So use delivery_channel se o USUARIO indicou EXPLICITAMENTE um canal DIFERENTE do atual."
        "\n\nCAMPOS DO SLIDE:"
