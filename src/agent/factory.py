...
def create_agent_with_tools(
    ...
    try:
        ...
        video_instructions.append(
            ...
            "source_type='ai_motion' gera cenas REALISTICAS do usuario em cenarios diferentes (usa avatar salvo no perfil).\n"
            "- setup_avatar(media_urls, media_type): Configura o avatar do usuario para modo ai_motion. "
            "Aceita 1-4 fotos ou 1 video. Fica salvo no perfil para reutilizar.\n"
            ...
            "5. MODO DE VIDEO: Se o usuario tem avatar configurado, sugira ai_motion "
            "(cenarios realisticos). Se nao, ofereca avatar (foto) ou real (video gravado). "
            "Para ai_motion, verifique se o avatar existe; se nao, peca para configurar com setup_avatar.\n"
